...
enum class FibonacciMethod { Recursive, DynamicProgramming };
...
int main() {
  ...
  std::cout
      ...
      << "a recursive algorithm and an iterative dynamic programming algorithm."
      << std::endl;
  ...
  while (true) {
    ...
    std::cout << std::endl
              << "How many times do you want to perform the calculation (in "
                 "order to find an average running time): ";
    std::cin >> times;

    auto recursiveTime =
        measureExecutionTime(FibonacciMethod::Recursive, n, times);
    auto dpTime =
        measureExecutionTime(FibonacciMethod::DynamicProgramming, n, times);

    std::cout << std::endl
              << "Recursive Approach:" << std::endl
              << "Result: " << calculateFibonacci(FibonacciMethod::Recursive, n)
              << std::endl
              << "Average Time: " << recursiveTime << " microseconds."
              << std::endl;

    std::cout << std::endl
              << "Dynamic Programming Approach:" << std::endl
              << "Result: "
              << calculateFibonacci(FibonacciMethod::DynamicProgramming, n)
              << std::endl
